...
export function SetupWizard({
  ...
  const wizardSteps = ["응대 기준", "상담 접수", "견적/정책", "팀", "확인"];
  ...
  const nextHint =
    step === 2 && !canContinue
      ? "문의를 받는 채널을 1개 이상 선택해야 합니다."
      : step === 3 && !canContinue
        ? "저장할 견적 기준과 정책 문구를 입력하거나 지식베이스 저장을 끄세요."
        : step === 4 && !canContinue
          ? "초대 이메일 형식을 확인하세요."
          : "";
    ...
    <div className="wizard-backdrop" role="dialog" aria-modal="true" aria-labelledby="wizardTitle">
      <section className="wizard">
        <div className="wizard-head">
          <div>
            <p className="eyebrow">Studio onboarding</p>
            <h2 id="wizardTitle">스튜디오 상담 기준 만들기</h2>
          </div>
        ...
        {step === 2 && (
          <div className="wizard-page active">
            ...
            <p>선택한 채널은 상담 접수 폼의 채널 목록으로 사용됩니다.</p>
            <div className="wizard-guide">
              <strong>DM과 카톡 상담을 한 곳에 모읍니다</strong>
              <span>인스타 DM, 카카오톡 등 실제로 문의를 받는 채널만 켜두면 접수가 단순해집니다.</span>
            </div>
            ...
            <div className="wizard-insight">
              <span>선택 상태</span>
              <strong>채널 {draft.channels.length}개</strong>
            </div>
          </div>
        )}
        ...
        {step === 3 && (
          <div className="wizard-page active">
            <h3>견적 기준과 예약 정책을 준비하세요</h3>
            <p>AI 초안이 참고할 스튜디오 운영 기준을 온보딩에서 바로 정리합니다.</p>
            <div className="wizard-guide">
              <strong>좋은 답변 초안의 재료입니다</strong>
              <span>시술별 가격, 예약금/취소 정책, 커버업 조건, 애프터케어처럼 반복해서 안내하는 내용을 한 줄씩 넣어두면 답변에 바로 반영됩니다.</span>
            </div>
            ...
            <div className="wizard-insight">
              <span>지식베이스 준비도</span>
              <strong>
                견적 항목 {priceLineCount}개 · 정책 문구 {faqLineCount}개
              </strong>
            </div>
          </div>
        )}
        ...
        {step === 5 && (
          <div className="wizard-page active">
            ...
            <div className="wizard-preview-list">
              ...
              <div>
                <span>지식베이스</span>
                <strong>{draft.loadDefaults ? `견적 ${priceLineCount}개 · 정책 문구 ${faqLineCount}개 저장` : "이번에는 저장하지 않음"}</strong>
              </div>
              <div>
                <span>팀 초대</span>
            ...
            <div className="wizard-guide">
              ...
              <span>상담 화면에서 실제 DM/카톡 문의를 넣어보고, 견적/안내 화면에서 예약금·애프터케어 문구를 스튜디오 기준으로 조정하세요.</span>
            </div>
          </div>
        )}
